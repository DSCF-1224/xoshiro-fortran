module pkg_xoshiro512plus1_c_interface
    ...
    private
    public  :: typ_xoshiro512plus1_c



    type , extends(typ_generator64_c_base) :: typ_xoshiro512plus1_c
        ...
        procedure , public  , nopass :: output_state                  => get_state_xoshiro512plus1



        ! kind: `SUBROUTINE`

        procedure , public  , nopass :: jump_state                 => jump_state_xoshiro512plus1
        procedure , public  , nopass :: jump_state_long            => jump_state_long_xoshiro512plus1
        procedure , private , nopass :: random_number_scalar_int64 => random_number_scalar_int64_xoshiro512plus1
        procedure , public  , nopass :: set_state                  => set_state_xoshiro512plus1

    end type typ_xoshiro512plus1_c
    ...
    pure elemental function get_state_xoshiro512plus1 ( i ) result(state)
    ...
    end function get_state_xoshiro512plus1



    subroutine jump_state_xoshiro512plus1 ()
        call jump_c_interface
    end subroutine jump_state_xoshiro512plus1



    subroutine jump_state_long_xoshiro512plus1 ()
        call long_jump_c_interface
    end subroutine jump_state_long_xoshiro512plus1



    subroutine random_number_scalar_int64_xoshiro512plus1 ( harvest )
    ...
    subroutine set_state_xoshiro512plus1 ( i , new_state )
    ...
    end subroutine set_state_xoshiro512plus1

end module pkg_xoshiro512plus1_c_interface
