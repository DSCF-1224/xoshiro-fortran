module pkg_xoshiro512plus2_c_interface
    ...
    private
    public  :: typ_xoshiro512plus2_c



    type , extends(typ_generator64_c_base) :: typ_xoshiro512plus2_c
        ...
        procedure , public  , nopass :: output_state                  => get_state_xoshiro512plus2



        ! kind: `SUBROUTINE`

        procedure , public  , nopass :: jump_state                 => jump_state_xoshiro512plus2
        procedure , public  , nopass :: jump_state_long            => jump_state_long_xoshiro512plus2
        procedure , private , nopass :: random_number_scalar_int64 => random_number_scalar_int64_xoshiro512plus2
        procedure , public  , nopass :: set_state                  => set_state_xoshiro512plus2

    end type typ_xoshiro512plus2_c
    ...
    pure elemental function get_state_xoshiro512plus2 ( i ) result(state)
    ...
    end function get_state_xoshiro512plus2



    subroutine jump_state_xoshiro512plus2 ()
        call jump_c_interface
    end subroutine jump_state_xoshiro512plus2



    subroutine jump_state_long_xoshiro512plus2 ()
        call long_jump_c_interface
    end subroutine jump_state_long_xoshiro512plus2



    subroutine random_number_scalar_int64_xoshiro512plus2 ( harvest )
    ...
    subroutine set_state_xoshiro512plus2 ( i , new_state )
    ...
    end subroutine set_state_xoshiro512plus2

end module pkg_xoshiro512plus2_c_interface
