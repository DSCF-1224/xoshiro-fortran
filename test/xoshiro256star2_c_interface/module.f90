module pkg_xoshiro256star2_c_interface
    ...
    private
    public  :: typ_xoshiro256star2_c



    type , extends(typ_generator64_c_base) :: typ_xoshiro256star2_c
        ...
        procedure , public  , nopass :: output_state                  => get_state_xoshiro256star2



        ! kind: `SUBROUTINE`

        procedure , public  , nopass :: jump_state                 => jump_state_xoshiro256star2
        procedure , public  , nopass :: jump_state_long            => jump_state_long_xoshiro256star2
        procedure , private , nopass :: random_number_scalar_int64 => random_number_scalar_int64_xoshiro256star2
        procedure , public  , nopass :: set_state                  => set_state_xoshiro256star2

    end type typ_xoshiro256star2_c
    ...
    pure elemental function get_state_xoshiro256star2 ( i ) result(state)
    ...
    end function get_state_xoshiro256star2



    subroutine jump_state_xoshiro256star2 ()
    ...
    subroutine jump_state_long_xoshiro256star2 ()
    ...
    subroutine random_number_scalar_int64_xoshiro256star2 ( harvest )
    ...
    subroutine set_state_xoshiro256star2 ( i , new_state )
...
end module pkg_xoshiro256star2_c_interface
